#!/usr/bin/python3
""" this is rectangle project on alx.
"""


class Rectangle:
    """This code takes in arguments for the width and height of rectangle, and contains methods which calculate the area or perimeter.
    ...
    def __init__(self, width=0, height=0):
        #this attribute assigment here engages setters defined below
        self.width = width
        self.height = height
    ...
    def area(self):
        """This returns the area of a rectangle of a given `width` and `height`.
