...
class Rectangle:
    ...
    This takes arguments for width and height of a rectangle,which contains methods
    ...
    def __str__(self):
        ...
        Returns:
            The output of _draw_rectangle, and creates a string
