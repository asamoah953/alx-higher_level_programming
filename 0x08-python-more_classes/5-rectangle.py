#!/usr/bin/python3
"""My rectangle alx-project
"""


class Rectangle:
    """This class takes in argumnets for width and height of a rectangle, which contains methods for calculation of the area or perimeter.
